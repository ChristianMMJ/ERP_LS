...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->SetFillColor(250, 250, 250);
        $this->SetX($pos[1]);
        $this->Cell($anc[1], $alto_celda, utf8_decode(''), 1/* BORDE */, 0, 'L');
        ...
        $this->SetFillColor(250, 250, 250);
        $this->SetX($pos[3]);
        $this->Cell($anc[2], $alto_celda, utf8_decode(''), 1/* BORDE */, 1, 'L');
        ...
        $this->SetFillColor(250, 250, 250);
        $this->SetX($pos[6]);
        $this->Cell($anc[4], $alto_celda, utf8_decode(''), 1/* BORDE */, 1, 'L');
