<div class="modal " id="mdlConfirmaReporteCapturaFisica"  role="dialog">
...
<script>
    var master_url = base_url + 'index.php/ReporteMaterialProduccionEstilo/';
    ...
    $(document).ready(function () {
        ...
        mdlMaterialSemanaProduccionEstilo.find('#btnImprimir').on("click", function () {
            ...
            $.ajax({
                url: master_url + 'onReporteMaterialSemanaProdEstilo',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
